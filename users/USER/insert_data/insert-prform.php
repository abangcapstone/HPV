...
if(!empty($_POST)) {
    ...
    $prno = mysqli_real_escape_string($dbcon, $_POST['prNo']);
    $prdatesub = mysqli_real_escape_string($dbcon, $_POST['dateSubmitted']);
    ...
    foreach($prinvoiceno AS $key => $value) {
        ...
        if(!$insert){
            ...
            header ('Location: /HPV/users/USER/paymentrequestform.php');
    ...
    $sql = "INSERT INTO paymentrequests (prno,prcomp,prdatesubmitted,prrequestedby,prpreparedby,prtitle,prdateneeded,prattention,prdept,prstatus,prtotal) VALUES('$prno','$prcompany','$prdatesub','$prrqstdby','$prprepby','$prtitle','$prdatened','$prattention','$prdepartment', 'FOR PRINT','$prtotal')";
