                                                    ...
                                                    while($row = $result->fetch_object()) {
                                                        ...
                                                        ?>
                                                                ...
                                                                if($row->brstatus == "APPROVED") {
                                                                    ?>
                                                                    <td>
                                                                        <a class="btn btn-success btn-xs"> <?php echo $row->brstatus ?> </a>
                                                                    </td>
                                                                    <?php
                                                                }
                                                                    ...
                                                                    ?>
                                                                    <td>
                                                                        <a class="btn btn-danger btn-xs"> <?php echo $row->brstatus ?> </a>
                                                                    </td>
                                                                    <?php
                                                                }
                                                                else{
    ...
    $(document).ready(function(){
        $(document).on('click', '.view_data', function(ev){
            ...
            $.ajax({
                ...
                url:"../USER/update_data/view-br.php",
                method:"POST",
    ...
    $(document).ready(function(){
        $(document).on('click', '.edit_data', function(ev){
            ...
            $.ajax({
                ...
                url:"../USER/update_data/view-budget.php",
                method:"POST",
                data:{br_number:br_number},
                //dataType:"json",
                success:function(data){
