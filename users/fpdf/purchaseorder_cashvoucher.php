...
function  getdata(){
    ...
    $query = mysqli_query($dbcon, "SELECT * FROM vouchers WHERE voucherno = '$code'");
    $result = $query->fetch_object();
    if($result->voucherstatus == "PRINT"){
        $dbcon->query("UPDATE vouchers SET voucherstatus = 'REPRINT' WHERE voucherno = '$code'");
    }
