...
<form class="form-horizontal form-label-left" id="UpdatePaymentForm" method="POST" >
    ...
    <div class="form-group">
        <label class="textsize control-label col-md-3 col-sm-3 col-xs-9 ">Official Receipt #:</label >
        <div class="col-md-6 col-sm-6 col-xs-9 ">
    ...
    <div class="form-group">
        <div class="col-md-6 col-sm-9 col-xs-12 col-md-offset-6">
...
<script>
    $('#UpdatePaymentForm').on("submit",function(event) {
        ...
        $.ajax({
            ...
            url:"../ACCOUNTING/update_data/update-popaymentdate.php",
            method:"POST",
