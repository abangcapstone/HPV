...
$row = $companyRows->fetch_object();
$categoryRows = $dbcon->query("SElECT * FROM categories");
                            ...
                            <form class="form-horizontal form-label-left" method="post">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-1 col-sm-2 col-xs-9"
                                               for="compBranch">Year:
                                        </label>
                                        <div class="col-md-3 col-sm-4 col-xs-9">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-1 col-sm-2 col-xs-9"
                                                   for="compBranch">Month:
                                            </label>
                                            <div class="col-md-3 col-sm-4 col-xs-9">
                                                <select name="month" id="month" class="selectpicker form-control" required>
                                                    <option value="" selected>Please select month.</option>
                                                    <?php
                                                    for($i = 1; $i <= 12; $i++){
                                                        ?>
                                                        <option value="<?php echo date('F', mktime(0,0,0, $i,1)) ?>"> <?php echo date('F', mktime(0,0,0, $i,1)) ?> </option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                ...
                                <div class="form-group has-feedback">
                                    <label class="textsize control-label col-md-1 col-sm-2 col-xs-9 ">Category:</label >
                                    <div class="col-md-3 col-sm-4 col-xs-9">
                                        <select id="category" name="category" class="selectpicker form-control" required >
                                            <option value="" selected>Please select category.</option>
                                            <?php
                                            if($categoryRows->num_rows > 0) {
                                                while($row = $categoryRows->fetch_object()) {
                                                    ?>
                                    ...
                                    <div class="item form-group">
                                        <label style="display:none" id="overheadLabel" class="control-label col-md-1 col-sm-2 col-xs-9"
                                               for="compBranch">Overhead:
                                        </label>
                                        <div class="col-md-3 col-sm-4 col-xs-9"  style="display:none" id="overheadDiv">
                                            <select name="overhead" id="overhead" class="selectpicker form-control" required>
                                                <option value="" selected>Please select overhead.</option>
                                                ...
                                                <option value="SEA Residence">SEA Residence</option>
                                            </select>
                                        </div>
                                        <div class="item form-group">
                                            <div class="col-md-1 col-sm-4 col-xs-9 col-md-offset-1">
...
<script>
    $(document).ready(function(){
        $(document).on('click', '.edit_data', function(ev){
            ...
            var month_code = $('#month').val();
            var cat_code = $('#category').val();
            var oh_code = $('#overhead').val();
            if(company_code != "" && year_code != "" && month_code != "" && cat_code != "") {
                $.ajax({
                    url:"../ACCOUNTING/update_data/viewspecificreports.php",
                    method:"POST",
                    data:{'company_code':company_code, 'year_code':year_code, 'month_code':month_code, 'cat_code':cat_code, 'oh_code':oh_code},
