...
$company = $dbcon->query("SELECT * FROM companies");
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form class="form-horizontal form-label-left "  id="CreateBudgetForm" name="CreateBudgetForm" action="insert_data/insert-brform.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            ...
                                            <button type="submit" name="insert" id="insert" class="btn btn-success pull-right">Create</button>
                                        </div>
                                    </div>
...
<!--        $.ajax({-->
<!--            url:"../ACCOUNTING/insert_data/insert-brform.php",-->
<!--            method:"POST",-->
...
<!--                $("#UpdateDiv").show();-->
<!--                $("#UpdateMessage").text("Budget Request Created");-->
<!--                setTimeout(function(){-->
<!--                    location.reload();-->
<!--                }, 500);-->
<!--            }-->
