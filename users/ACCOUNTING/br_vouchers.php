...
$result = $dbcon->query("SELECT * FROM budgetrequests");
$sql5 = $dbcon->query("SELECT * FROM budgetrequests WHERE brstatus LIKE 'APPROVED' AND brno NOT IN (SELECT voucheridentifier FROM vouchers)");
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Budget Request Vouchers</h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <form class="form-horizontal form-label-left " method="POST" id="CreatePOVoucherForm" name="CreatePOVoucherForm" action="insert_data/insert-brvoucher.php">


                                    <div class=" form-group has-feedback">
                                        <label class="control-label col-md-2 col-sm-2 col-xs-9">BR#:</label>
                                        <div class="col-md-3 col-sm-3 col-xs-9">
                                            <select id="brnumber" name="brnumber" class="selectpicker form-control" required >
                                                <option value="" selected>Please select BR number.</option>
                                                ...
                                                if($sql5->num_rows > 0) {
                                                    while($po = $sql5->fetch_assoc()) {
                                                        ?>
                                                        <option value="<?php echo $po['brno'] ?>"> <?php echo $po['brno'] ?> </option>
                                    ...
                                    <div class=" form-group has-feedback">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-9">
                                            <input id="voucherClient" name="voucherClient" type="text" class="form-control" placeholder="Default Input">
                                        </div>
                                    ...
                                    <div class=" form-group has-feedback">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-9">
                                            <input id="voucherAddr" name="voucherAddr" type="text" class="form-control" placeholder="Default Input">
                                        </div>
...
<script>
    $(document).ready(function(e){
        $('#brnumber').change (function(){
            ...
            $.ajax({
                url:"../Accounting/update_data/fetch-br.php",
                method:"POST",
                data:{br_number:br_number},
                dataType:"json",
                success:function(data){
