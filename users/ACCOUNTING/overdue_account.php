...
$result = $dbcon->query("SELECT * FROM overheads,companies,overheaddetails WHERE overheadcomp = compno AND overheadstatus = 'OVERDUE' AND overheaddetailscode = overheadcode");
$view = $dbcon->query("SELECT * FROM purchaseorder, companies,clients WHERE pocompany = compno AND postatus = 'OVERDUE' AND poclient = clientcode");
$dbcon->close();
?>
<!DOCTYPE html>
<html lang="en">
