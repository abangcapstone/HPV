                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <form class="form-horizontal form-label-left " method="POST"
                                  action="insert_data/insert-overheads.php">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-9">
                                            <select id="compBranch" name="compBranch" class="selectpicker
...
<script>
    $(document).ready(function(e){
        ...
        //variables
        var html= ' <div class="container "> <div class="col-md-2 col-sm-9 col-xs-9" id="added"> <input type="text"class=" form-control" id="businessname"name="businessname[]" placeholder="Business Name" required> </div> <div class="col-md-2 col-sm-9 col-xs-9" id="added"> <input type="text" class=" form-control" id="address"name="address[]" placeholder="Address" required> </div> <div class="col-md-2 col-sm-9 col-xs-9" id="added"> <input type="number" class=" form-control " id="contactdetails"name="contactdetails[]" placeholder="Contact Details" required> </div> <div class="col-md-1 col-sm-9 col-xs-9" id="added"> <input type="text" class="form-control " id="unit" name="unit[]" required> </div> <div class="col-md-2 col-sm-9 col-xs-9"  id="added"> <input type="number" class="form-control " id="amount" name="amount[]"placeholder="Amount" required> </div> <div class="col-md-2 col-sm-9 col-xs-9" id="added"> <input type="text" class="form-control " id="duedate" name="duedate[]" placeholder="Due date" required> </div> <div class="col-md-1 col-sm-1 col-xs-9" id="added"> <a id= "remove" name="remove" type="button" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-minus"></span></a> </div> </div>';
