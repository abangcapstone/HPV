                                                    ...
                                                    while($row = $result->fetch_object()) {
                                                        if($row->prstatus == "APPROVED") {
                                                            ...
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td> <a href='#ViewPrModal' data-toggle='modal' id="edit" class="btn btn-primary btn-xs edit_data" data-id="<?php echo $row->prno ?>"> <span class="fa fa-eye" aria-hidden="true"></span> View
                                                                    </a>
                                                                </td>
                                                                ...
                                                                <td><a class="btn btn-success btn-xs"> <?php echo $row->prstatus ?> </a></td>
