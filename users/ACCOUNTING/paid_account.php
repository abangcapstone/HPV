...
$result = $dbcon->query("SELECT * FROM overheads,companies,overheaddetails,transactions WHERE overheadcomp = compno AND overheadstatus = 'PAID' AND overheaddetailscode = overheadcode AND overheadcode = transaccode");
$view = $dbcon->query("SELECT * FROM purchaseorder, companies,clients WHERE pocompany = compno AND popaymentstatus = 'PAID' AND poclient = clientcode");
$dbcon->close();
?>
<!DOCTYPE html>
<html lang="en">
