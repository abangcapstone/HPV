            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Payment Request Vouchers</h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <form class="form-horizontal form-label-left " method="POST" id="CreatePOVoucherForm" name="CreatePOVoucherForm" action="insert_data/insert-prvoucher.php">


                                    <div class=" form-group has-feedback">
                                        <label class="control-label col-md-2 col-sm-2 col-xs-9">PR#:</label>
                                        <div class="col-md-3 col-sm-3 col-xs-9">
                                            <select id="prnumber" name="prnumber" class="selectpicker form-control" required >
                                                <option value="" selected>Please select PR number.</option>
                                                ...
                                                if($sql5->num_rows > 0) {
                                                    while($po = $sql5->fetch_assoc()) {
                                                        ?>
                                                        <option value="<?php echo $po['prno'] ?>"> <?php echo $po['prno'] ?> </option>
