                                ...
                                <div id="container">
                                    <div class="container ">
                                        ...
                                        <div class="col-md-2 col-sm-2 col-xs-9">
                                            <input type="text" class="form-control " step="any" id="duedate" name="duedate[]" placeholder="Due date" required>
                                        </div>
