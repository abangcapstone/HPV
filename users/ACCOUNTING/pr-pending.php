...
$result = $dbcon->query("SELECT * FROM paymentrequests, companies WHERE prcomp = compno AND prstatus != 'APPROVED'");
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Approved Payment Requests</h2>
                                                ...
                                                if($result->num_rows > 0) {
                                                    while($row = $result->fetch_object()) {
                                                            ...
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td> <a href='#ViewPrModal' data-toggle='modal' id="edit" class="btn btn-primary btn-xs view_data" data-id="<?php echo $row->prno ?>"> <span class="fa fa-eye" aria-hidden="true"></span> View
                                                                    </a>
                                                                    <a href='#ViewPrModal' data-toggle='modal' id="edit" class="btn btn-primary btn-xs edit_data" data-id="<?php echo $row->prno ?>"> <span class="fa fa-edit" aria-hidden="true"></span> Edit
                                                                    </a>
                                                                </td>

                                                                <td><?php echo $row->prno ?> </td>
                                                                <td><?php echo $row->prdatesubmitted ?></td>
                                                                <td> <?php echo $row->compname ?> </td>
                                                                <td><?php echo $row->prrequestedby ?></td>
                                                                <td><?php echo $row->prtotal ?></td>
                                                                <?php
                                                                  if($row->prstatus == "PENDING" ) {
                                                                      ?>
                                                                      <td>
                                                                          <a class="btn btn-warning btn-xs"> <?php echo $row->prstatus ?> </a>
                                                                      </td>


                                                                      <?php
                                                                  }
                                                                  else if( $row->prstatus == "FOR PRINT"){
                                                                   ?>
                                                                      <td>
                                                                          <a class="btn btn-info btn-xs"> <?php echo $row->prstatus ?> </a>
                                                                      </td>
                                                            </tr>
                                                               <?php
                                                                      }
...
<div id="ViewPrModal" class="modal fade createClient-modal-md" tabindex="-1" role="dialog" aria-hidden="true">
...
<!--<script src="../ACCOUNTING/update_data/view-pr.js"></script>-->
</body>
</html>
<script>
...
ev.preventDefault();
var pr_number = $(this).data("id");

$.ajax({
url:"../Accounting/update_data/view-pr.php",
method:"POST",
...
<script>
    $(document).ready(function(){
        $(document).on('click', '.edit_data', function(ev){
            ...
            $.ajax({
                url:"../Accounting/update_data/view-payment.php",
                method:"POST",
                data:{pr_number:pr_number},
