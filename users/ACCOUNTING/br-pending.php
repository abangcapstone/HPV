...
$result = $dbcon->query("SELECT * FROM budgetrequests, companies WHERE brcomp = compno AND brstatus != 'APPROVED' ");
                                                ...
                                                if($result->num_rows > 0) {
                                                    while($row = $result->fetch_object()) {
                                                            ...
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td> <a href='#ViewBrModal' data-toggle='modal' id="view" class="btn btn-primary btn-xs view_data" data-id="<?php echo $row->brno ?>"> <span class="fa fa-eye" aria-hidden="true"></span> View
                                                                    </a>
                                                                    <a href='#ViewBrModal' data-toggle='modal' id="edit" class="btn btn-primary btn-xs edit_data" data-id="<?php echo $row->brno ?>"> <span class="fa fa-edit" aria-hidden="true"></span> Edit
                                                                    </a>
                                                                </td>

                                                                <td><?php echo $row->brno ?> </td>
                                                                <td><?php echo $row->brdatesubmitted ?></td>
                                                                <td> <?php echo $row->compname ?> </td>
                                                                <td><?php echo $row->brrequestedby ?></td>
                                                                <td><?php echo $row->brtotal ?></td>
                                                                <?php
                                                        if($row->brstatus == "PENDING" ) {
                                                            ?>
                                                            <td>
                                                                <a class="btn btn-warning btn-xs"> <?php echo $row->brstatus ?> </a>
                                                            </td>
                                                            <?php
                                                        }
                                                        else if( $row->brstatus == "FOR PRINT"){
                                                            ?>
                                                                <td>
                                                                     <a class="btn btn-info btn-xs"> <?php echo $row->brstatus ?> </a>
                                                                </td>
                                                            <?php
                                                         }
                                                            ?>
...
<div id="ViewBrModal" class="modal fade createClient-modal-md" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Budget Request</h4>
            </div>
...
<!--<script src="../ACCOUNTING/update_data/view-br.js"></script>-->
<script>
...
<script>
    $(document).ready(function(){
        $(document).on('click', '.edit_data', function(ev){
            ...
            $.ajax({
                url:"../Accounting/update_data/view-budget.php",
                method:"POST",
                data:{br_number:br_number},
