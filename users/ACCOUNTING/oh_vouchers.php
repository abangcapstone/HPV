...
$result = $dbcon->query("SELECT * FROM paymentrequests");
$sql5 = $dbcon->query("SELECT * FROM paymentrequests WHERE prstatus LIKE 'APPROVED' AND prno NOT IN (SELECT voucheridentifier FROM vouchers)");
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Overhead Vouchers</h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <form class="form-horizontal form-label-left " method="POST" id="CreatePOVoucherForm" name="CreatePOVoucherForm" action="insert_data/insert-ohvoucher.php">


                                    <div class=" form-group has-feedback">
                                        <label class="control-label col-md-1 col-sm-2 col-xs-9">Overhead:</label>
                                        <div class="col-md-2 col-sm-3 col-xs-9">
                                                <select id="ohType" name="ohType" class="selectpicker form-control" required >
                                        ...
                                        <label class="control-label col-md-2 col-sm-2 col-xs-9">OH#:</label>
                                        <div class="col-md-3 col-sm-3 col-xs-9">
                                            <select id="ohNo" name="ohNo" class="selectpicker form-control" required >
                                                <option value="" selected>Please select type.</option>
                                            </select>
                                        </div>
                                        <label class="control-label col-md-2 col-sm-2 col-xs-9">Type:</label>
                                        <div class="col-md-2 col-sm-3 col-xs-9">
                                    ...
                                    <div class=" form-group has-feedback">
                                        ...
                                        <div style="display: none" id="inputLabel" class="col-md-3 col-sm-4 col-xs-9">
...
<script>
    $(document).ready(function(){
        $('#ohNo').change(function(){
            var oh_number = $(this).val();
            $.ajax({
                url:"../Accounting/update_data/view-voucherdetails.php",
                method:"POST",
                data:{oh_number:oh_number},
...
<script>
    $(document).ready(function(e){
        ...
        $('#ohNo').change (function(){
            ...
            $.ajax({
                url:"../Accounting/update_data/fetch-oh.php",
                method:"POST",
                data:{oh_no:oh_no},
                dataType:"json",
                success:function(data){
                    $('#voucherComp').val(data.compname);
                    $('#voucherClient').val(data.overheadname);
                    $('#voucherAddr').val(data.overheadaddr);
                }
            });
        });
    });
...
<script>
    $(document).ready(function(){
        $('#ohType').change (function(){
            var oh_type = $(this).val();
            $.ajax({
                url:"../Accounting/update_data/fetch-oh.php",
                method:"POST",
...
<script>
    ...
    $(function() {
        var content = $('#voucherClient').val();

        $('#voucherClient').change(function() {
            if ($('#voucherClient').val() != content) {
                content = $('#voucherClient').val();
                $.ajax({
                    url:"../Accounting/update_data/fetch-pr.php",
                    method:"POST",
