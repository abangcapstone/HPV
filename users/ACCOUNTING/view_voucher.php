...
$result = $dbcon->query("SELECT * FROM vouchers");
$dbcon->close();
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <div class="row"><div class="col-sm-12">
                                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 84.8889px;" aria-label="Last name: activate to sort column ascending">No.
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 84.8889px;" aria-label="Last name: activate to sort column ascending">Identifier
                                                    </th>

                                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 84.8889px;" aria-label="Last name: activate to sort column ascending">Type
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 182.889px;" aria-label="Position: activate to sort column ascending">Date
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 81.8889px;" aria-label="Office: activate to sort column ascending">Prepared By
                                                    </th>
                                                ...
                                                if($result->num_rows > 0) {
                                                    while($row = $result->fetch_object()) {
                                                            ...
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td> <a href='#ViewVoucherModal' data-toggle='modal' id="edit" class="btn btn-primary btn-xs edit_data" data-id="<?php echo $row->voucherno ?>"> <span class="fa fa-eye" aria-hidden="true"></span> View
                                                                    </a>
                                                                </td>

                                                                <td><?php echo $row->voucherno ?> </td>
                                                                <td><?php echo $row->voucheridentifier ?></td>
                                                                <td> <?php echo $row->vouchertype ?> </td>
                                                                <td><?php echo $row->voucherdate ?></td>
                                                                <td><?php echo $row->voucherpreparedby?></td>
                                                                <?php
                                                                    if($row->voucherstatus == 'PRINT') {
                                                                        ?>
                                                                        <td>
                                                                            <a class="btn btn-success btn-xs"> <?php echo $row->voucherstatus ?> </a>
                                                                        </td>
                                                                        <?php
                                                                    }
                                                                    else {
                                                                        ?>
                                                                        <td>
                                                                            <a class="btn btn-warning btn-xs"> <?php echo $row->voucherstatus ?> </a>
                                                                        </td>
                                                                        <?php
                                                                    }
                                                                        ?>
...
<div id="ViewVoucherModal" class="modal fade createClient-modal-md" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    $(document).ready(function(){
        $(document).on('click', '.edit_data', function(ev){
            ev.preventDefault();
            var voucher_code = $(this).data("id");

            $.ajax({
                url:"../ACCOUNTING/update_data/viewvoucher.php",
                method:"POST",
