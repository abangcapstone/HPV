...
$prVoucher = $values['prVoucher'];
        ...
        $result = $dbcon->query("SELECT * FROM purchaseorder, companies WHERE compno = pocompany");
        $dbcon->close();
?>
<!DOCTYPE html>
<html lang="en">
                              ...
                              <thead>
                                <tr role="row">
                                 ...
                                 <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 79.8889px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Actions
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 84.8889px;" aria-label="Last name: activate to sort column ascending">Date
                                  </th>
                                  
                                   <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 84.8889px;" aria-label="Last name: activate to sort column ascending">Subject
                                  </th>
                                  <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 182.889px;" aria-label="Position: activate to sort column ascending">Client
                                  </th>
                              ...
                              <?php 
                                if($result->num_rows > 0) {
                                  while($row = $result->fetch_object()) {
                                    if($row->postatus == "PENDING") {
                                  ?>
                                    <tr role="row" class="odd">
                                       
                                      <td> <a href='#ViewPoModal' data-toggle='modal' id="edit" class="btn btn-primary btn-xs edit_data" data-id="<?php echo $row->ponumber ?>"> <span class="fa fa-eye" aria-hidden="true"></span> View
                                                </a> 
                                        </td>
                                        ...
                                        <td><?php echo $row->poclient ?></td>
                                        <td><?php echo $row->pototal ?></td>
                                        <td><a class="btn btn-warning btn-xs"> <?php echo $row->postatus ?> </a></td>
